...
photo1 = PhotoImage(file="button.gif")
...
connectButton = Button(root, text="Connect", command=adjustRoasterType, bd=0, highlightthickness=0, bg='black', fg='red',image=photo1, highlightbackground=backgroundColor)
